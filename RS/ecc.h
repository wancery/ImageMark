...
void decode_data(unsigned char data[], unsigned char decdatabin[]);
void encode_data (unsigned char msg[], unsigned char dst1[]);
//unsigned char * encode_data(unsigned char msg[], int nbytes);
...
void get2string(unsigned char *s, unsigned char *b);
void get2string(unsigned char *s, unsigned char *b, int len);
